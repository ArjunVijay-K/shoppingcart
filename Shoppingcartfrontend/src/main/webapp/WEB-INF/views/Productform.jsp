...
<div class="container" >
		<div class="jumbotron" style="background-color:#EAECEE">
			...
			<form action="newproduct"class="form-horizontal"  method="post" action="newUser"  role="form" name="newproduct">
				...
				<div style="color: #27A4F7" class="form-group">
					...
					<input  class="form-control" placeholder="Enter category of the product" type="text"  id="category" name="category" >
				</div>
				
				<div style="color: #27A4F7" class="form-group">
					<label for="text">Supplier :</label> 
					<input  class="form-control" placeholder="Enter Supplier of the product" type="text"  id="supplier_Name" name="supplier_Name" >
				</div>
